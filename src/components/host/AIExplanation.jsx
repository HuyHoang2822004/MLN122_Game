      ...
      <div className="p-8">
        ...
        <div className="flex items-start gap-4 mb-6">
          <motion.div
            ...
            style={{
              background: 'linear-gradient(135deg, rgba(22,163,74,0.3), rgba(20,184,166,0.2))',
        ...
        >
          ...
          <div>
            <span className="text-xs font-semibold uppercase" style={{ color: '#22C55E' }}>Đáp án đúng: </span>
            <span className="text-sm font-bold" style={{ color: '#4ADE80' }}>
              {mission.correct}. {mission.choices.find(c => c.id === mission.correct)?.text}
            </span>
          </div>
        </motion.div>
        ...
        {mission.references && mission.references.length > 0 && (
          ...
          >
            <div className="text-xs font-bold tracking-widest uppercase mb-3" style={{ color: '#475569' }}>
              📚 Tài liệu tham khảo
            </div>
