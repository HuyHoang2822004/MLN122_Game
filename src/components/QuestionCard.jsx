...
const QuestionCard = ({ mission, onCorrect, darkMode }) => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Card header strip */}
        <div className="h-1" style={{ background: `linear-gradient(90deg, ${mission.color}, ${mission.color}88)` }} />

        <div className="p-5">
          {/* Stage badge + icon */}
          <div className="flex items-center gap-3 mb-5">
            <div className="p-2.5 rounded-xl" style={{ background: `${mission.color}18` }}>
          ...
          {/* Divider */}
          <div className="mb-5" style={{ borderTop: darkMode ? '1px solid rgba(255,255,255,0.06)' : '1px solid rgba(0,0,0,0.06)' }} />
          ...
          <div className="flex flex-col gap-3">
            {mission.choices.map((choice) => {
              ...
              return (
                ...
                >
                  {/* Choice letter badge */}
                  <div className="flex-shrink-0 w-8 h-8 rounded-lg flex items-center justify-center text-xs font-bold transition-all duration-200"
                    style={{
                      background: showCheck
                        ...
                        ? 'rgba(34,197,94,0.2)'
                        : darkMode ? 'rgba(255,255,255,0.06)' : 'rgba(37,99,235,0.08)',
                      color: showCheck || showX
                        ? 'white'
                        : isCorrect && isThisCorrect
                        ? '#22C55E'
                        : mission.color,
